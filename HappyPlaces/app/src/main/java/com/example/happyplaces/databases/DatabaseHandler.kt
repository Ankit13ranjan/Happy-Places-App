...
class DatabaseHandler(context: Context) :
    ...
    fun addHappyPlace(happyPlace: HappyPlaceModels): Long {
    ...
    fun deleteHappyPlace(happyPlace:HappyPlaceModels) : Int{
        val db=this.writableDatabase
    ...
    fun updateHappyPlace(happyPlace: HappyPlaceModels): Int {
        val db = this.writableDatabase
    ...
    fun getHappyPlacesList():ArrayList<HappyPlaceModels>{
        val happyPlaceList = ArrayList<HappyPlaceModels>()

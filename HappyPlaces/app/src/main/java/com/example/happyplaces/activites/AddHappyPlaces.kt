...
class AddHappyPlaces : AppCompatActivity(), View.OnClickListener {
    ...
    private var mHappyPlaceDetails: HappyPlaceModels? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setSupportActionBar(toolbar_add_places) // Use the toolbar to set the action bar.
        ...
        if (!Places.isInitialized()) {
            Places.initialize(
                this@AddHappyPlaces,
                resources.getString(R.string.google_maps_key1)
            )
        }
        ...
        if (intent.hasExtra(MainActivity.EXTRA_PLACE_DETAILS)) {
            mHappyPlaceDetails =
                intent.getSerializableExtra(MainActivity.EXTRA_PLACE_DETAILS) as HappyPlaceModels
        }
            ...
            R.id.btn_save -> {
                ...
                when {
                    ...
                    saveImageToInternalStorage == null -> {
                        ...
                        val happyPlaceModel = HappyPlaceModels(
    ...
    private val mLocationCallback = object : LocationCallback() {
        override fun onLocationResult(locationResult: LocationResult) {
            ...
            val addressTask =
                GetAddressFromLatLng(this@AddHappyPlaces, mLatitude, mLongitude)
